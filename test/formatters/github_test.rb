...
require "cleo_quality/formatters/github"
  ...
  module Formatters
    class GithubTest < Minitest::Test
      def test_prints_github_warning_annotations_and_summary_notice
        ...
        assert_includes output, "::notice title=Cleo Quality Summary::"
        assert_includes output, "Cleo Quality top actionable issues."
      end
