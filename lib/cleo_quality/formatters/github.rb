  ...
  module Formatters
    class Github
      ...
      def summary_annotation
        ...
        "::notice title=Cleo Quality Summary::#{escape_message(summary_message(selected_findings))}"
      end
      ...
      def summary_limit
        Integer(ENV.fetch("CLEO_QUALITY_GITHUB_SUMMARY_LIMIT", DEFAULT_SUMMARY_LIMIT))
